...
# parses through the jso metrics file to visualize the results. 
...
# choose th proper checkpoint by looking at when the validation and training loss starts to level out.
    # this point might be different for val and training. Look at the minimum epoch point for where the validation or training levels out. 
