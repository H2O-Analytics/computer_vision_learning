...
class PointCloud(ABC):
    ...
    def from_file_multisweep(cls, lyftd, sample_rec: Dict, chan: str, ref_chan: str, num_sweeps: int = 26, min_distance: float = 1.0) -> Tuple["PointCloud", np.ndarray]:
        ...
        # Get references post and timestamp
        ...
        # Homogenous transform from ego car frame to reference frame
